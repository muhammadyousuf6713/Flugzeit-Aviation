                                ...
                                <div class="row">
                                    <div class="col-md-12 col-lg-12 col-xl-12">
                                        <div class="card card-body pd-40">
                                            <h4 class="card-title mg-b-20">Add Academic Programme </h4>
                                            <form method="post" action="{{ route('academic-program.store') }}">
                                                @csrf
                                                @if (count($errors) > 0)
                                                    <div class="p-1">
                                                ...
                                                <hr>
                                                <a type="submit" href="{{ route('academic-program.list') }}"
