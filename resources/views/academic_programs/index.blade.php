                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0 d-flex flex-wrap justify-content-between align-items-center">
                            ...
                            <div class="justify-content-between ">
                                <a href="{{ route('academic-program.create') }}" class="btn btn-primary  text-white"><i
                                        class="fas fa-plus"></i>
                                    Programme</a>
                                <a href="{{ route('academic-program-category.create') }}"
                                    ...
                                    <tbody>
                                        @forelse ($academicPrograms as $program)
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        @forelse ($program->categories as $category)
                                                            <li>
                                                ...
                                                <td>
                                                    <a href="{{ route('academic-program.edit', $program->id) }}"
                                                        class="btn  btn-warning"><i class="fas fa-edit"></i></a>
                                                    <form action="{{ route('academic-program.destroy', $program->id) }}"
