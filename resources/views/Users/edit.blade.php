                ...
                <div class="card-body px-4 pt-4 pb-2">
                    <form action="{{ url('users/update/' . $users->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="{{ old('name', $users->name) }}" type="text" placeholder="Name" id="user-name" name="name">
                                    @error('name')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" value="{{ old('email', $users->email) }}" type="email" placeholder="@fza.com" id="user-email" name="email">
                                    @error('email')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="role_id" name="role_id" class="form-control">
                                        ...
                                        @foreach ($roles as $role)
                                            <option {{ old('role_id', $users->role_id) == $role['id'] ? 'selected' : '' }} value="{{ $role['id'] }}">{{ $role['name'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('role_id')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select id="status" name="status" class="form-control">
                                        ...
                                        <option value="0" {{ $users->status == 0 ? 'selected' : '' }}>In-Active</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="submit" class="btn bg-gradient-primary btn-md">Update User</button>
                        </div>
                    </form>
                </div>
            </div>
