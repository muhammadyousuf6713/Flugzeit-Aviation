...
@section('content')
    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <div class="card card-body pd-40">
            ...
            <h2 class="az-content-title" style="display: inline">Create  Sales Reference <span><a href="{{ url('sales-reference') }}"
                ...
                <div class="container-fluid">
                    ...
                    <div class="az-content-body d-flex flex-column">
                        <form id="myForm" method="post" action="{{ url('sales-reference/store') }}">
                                ...
                                <div class="row row-sm mg-b-20">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="az-content-label tx-11 tx-medium tx-gray-600">Sales Reference Name <span style="color:red;">*</span></label>
                            ...
                            <a type="button" href="{{ url('sales-reference') }}" class="btn btn-danger btn-block mt-2">
                                Cancel
                            </a>
