    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <div class="card card-body pd-40">
            <div class="az-content-breadcrumb ">
                <span> Edit Sales Reference</span>
                <span>Edit Sales Reference</span>
            </div>
            <h2 class="az-content-title" style="display: inline">Edit Sales  Reference<span><a href="{{ url('sales-reference') }}"
            ...
            <div class="az-content">
                <div class="container-fluid">
                    ...
                    <div class="az-content-body d-flex flex-column">
                        ...
                        <form class="form-horizontal" method="post" action="{{ url('sales-reference/update/'.$edit_vendor->type_id) }}">
                            @csrf
                            <div class="row">
