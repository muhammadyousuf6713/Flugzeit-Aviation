                ...
                <div class="card mb-4 mx-4 shadow-sm border-0">
                    <div class="card-header pb-0 bg-white">
                        <div class="d-flex flex-row justify-content-between align-items-center">
                            <div>
                                <h5 class="mb-0 fw-bold">Sales References List</h5>
                            </div>
                            <a href="{{ url('sales-reference/create') }}" class="btn bg-gradient-primary btn-sm mb-0 text-uppercase"
                                type="button"><i class="fa fa-plus me-1"></i> Add Sales Reference</a>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $sales_reference->type_name }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-xs text-secondary">{{ date('d M Y', strtotime($sales_reference->created_at)) }}
                                            </td>
