...
@section('content')
    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <div class="card card-body pd-40">
            ...
            <h2 class="az-content-title" style="display: inline">Create  Service <span><a href="{{ url('services') }}"
                        class="btn btn-az-primary" style="float: right">Service List</a></span></h2>

            <div class="az-content">
                <div class="container-fluid">

                    <div class="az-content-body d-flex flex-column">
                        <form id="myForm" method="post" action="{{ url('services/store') }}">
                            @csrf
                            @if (count($errors) > 0)
                                <div class="p-1">
                                ...
                                <div class="row row-sm mg-b-20">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="az-content-label tx-11 tx-medium tx-gray-600">Service Name <span style="color:red;">*</span></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="az-content-label tx-11 tx-medium tx-gray-600">Sub Service Name <span style="color:red;">*</span></label>
                                            <input type="text" name="service_name" class="form-control" value="{{ old('service_name') }}" required />
                                        </div>
                                        @error('service_name')
                                            <span ss="form-text text-danger">
                            ...
                            <a type="button" href="{{ url('services') }}" class="btn btn-danger btn-block mt-2">
                                Cancel
                            </a>
